...
class MockMetricsServiceV2Credentials < Google::Cloud::Logging::Credentials
...
describe Google::Cloud::Logging::V2::MetricsServiceV2Client do
  ...
  describe 'list_log_metrics' do
    ...
    it 'invokes list_log_metrics without error' do
      ...
      # Mock auth layer
      mock_credentials = MockMetricsServiceV2Credentials.new("list_log_metrics")
  ...
  describe 'get_log_metric' do
    ...
    it 'invokes get_log_metric without error' do
      ...
      # Mock auth layer
      mock_credentials = MockMetricsServiceV2Credentials.new("get_log_metric")
  ...
  describe 'create_log_metric' do
    ...
    it 'invokes create_log_metric without error' do
      ...
      # Mock auth layer
      mock_credentials = MockMetricsServiceV2Credentials.new("create_log_metric")
  ...
  describe 'update_log_metric' do
    ...
    it 'invokes update_log_metric without error' do
      ...
      # Mock auth layer
      mock_credentials = MockMetricsServiceV2Credentials.new("update_log_metric")
  ...
  describe 'delete_log_metric' do
    ...
    it 'invokes delete_log_metric without error' do
      ...
      # Mock auth layer
      mock_credentials = MockMetricsServiceV2Credentials.new("delete_log_metric")
