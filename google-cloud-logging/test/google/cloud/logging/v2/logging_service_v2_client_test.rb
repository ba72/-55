...
class MockLoggingServiceV2Credentials < Google::Cloud::Logging::Credentials
...
describe Google::Cloud::Logging::V2::LoggingServiceV2Client do
  ...
  describe 'delete_log' do
    ...
    it 'invokes delete_log without error' do
      ...
      # Mock auth layer
      mock_credentials = MockLoggingServiceV2Credentials.new("delete_log")
  ...
  describe 'write_log_entries' do
    ...
    it 'invokes write_log_entries without error' do
      ...
      # Mock auth layer
      mock_credentials = MockLoggingServiceV2Credentials.new("write_log_entries")
  ...
  describe 'list_log_entries' do
    ...
    it 'invokes list_log_entries without error' do
      ...
      # Mock auth layer
      mock_credentials = MockLoggingServiceV2Credentials.new("list_log_entries")
  ...
  describe 'list_monitored_resource_descriptors' do
    ...
    it 'invokes list_monitored_resource_descriptors without error' do
      ...
      # Mock auth layer
      mock_credentials = MockLoggingServiceV2Credentials.new("list_monitored_resource_descriptors")
  ...
  describe 'list_logs' do
    ...
    it 'invokes list_logs without error' do
      ...
      # Mock auth layer
      mock_credentials = MockLoggingServiceV2Credentials.new("list_logs")
