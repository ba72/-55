...
class MockConfigServiceV2Credentials < Google::Cloud::Logging::Credentials
...
describe Google::Cloud::Logging::V2::ConfigServiceV2Client do
  ...
  describe 'list_sinks' do
    ...
    it 'invokes list_sinks without error' do
      ...
      # Mock auth layer
      mock_credentials = MockConfigServiceV2Credentials.new("list_sinks")
  ...
  describe 'get_sink' do
    ...
    it 'invokes get_sink without error' do
      ...
      # Mock auth layer
      mock_credentials = MockConfigServiceV2Credentials.new("get_sink")
  ...
  describe 'create_sink' do
    ...
    it 'invokes create_sink without error' do
      ...
      # Mock auth layer
      mock_credentials = MockConfigServiceV2Credentials.new("create_sink")
  ...
  describe 'update_sink' do
    ...
    it 'invokes update_sink without error' do
      ...
      # Mock auth layer
      mock_credentials = MockConfigServiceV2Credentials.new("update_sink")
  ...
  describe 'delete_sink' do
    ...
    it 'invokes delete_sink without error' do
      ...
      # Mock auth layer
      mock_credentials = MockConfigServiceV2Credentials.new("delete_sink")
  ...
  describe 'list_exclusions' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Logging::V2::ConfigServiceV2Client#list_exclusions."
    ...
    it 'invokes list_exclusions without error' do
      ...
      mock_stub = MockGrpcClientStub.new(:list_exclusions, mock_method)

      # Mock auth layer
      mock_credentials = MockConfigServiceV2Credentials.new("list_exclusions")
  ...
  describe 'get_exclusion' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Logging::V2::ConfigServiceV2Client#get_exclusion."
    ...
    it 'invokes get_exclusion without error' do
      ...
      mock_stub = MockGrpcClientStub.new(:get_exclusion, mock_method)

      # Mock auth layer
      mock_credentials = MockConfigServiceV2Credentials.new("get_exclusion")
  ...
  describe 'create_exclusion' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Logging::V2::ConfigServiceV2Client#create_exclusion."
    ...
    it 'invokes create_exclusion without error' do
      ...
      mock_stub = MockGrpcClientStub.new(:create_exclusion, mock_method)

      # Mock auth layer
      mock_credentials = MockConfigServiceV2Credentials.new("create_exclusion")
  ...
  describe 'update_exclusion' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Logging::V2::ConfigServiceV2Client#update_exclusion."
    ...
    it 'invokes update_exclusion without error' do
      ...
      mock_stub = MockGrpcClientStub.new(:update_exclusion, mock_method)

      # Mock auth layer
      mock_credentials = MockConfigServiceV2Credentials.new("update_exclusion")
  ...
  describe 'delete_exclusion' do
    custom_error = CustomTestError.new "Custom test error for Google::Cloud::Logging::V2::ConfigServiceV2Client#delete_exclusion."
    ...
    it 'invokes delete_exclusion without error' do
      ...
      mock_stub = MockGrpcClientStub.new(:delete_exclusion, mock_method)

      # Mock auth layer
      mock_credentials = MockConfigServiceV2Credentials.new("delete_exclusion")
